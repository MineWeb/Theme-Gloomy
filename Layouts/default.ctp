    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="text-center"><p style="line-height: 1;color: #c4c4c4;font-size: initial;"><a data-dismiss="modal" href="#" data-toggle="modal"
												data-target="#lostpasswd" style="color: #c4c4c4;font-size: initial;">Mot de passe oublié ?</a></p></div>
			</div>
		</div>
      </div>
