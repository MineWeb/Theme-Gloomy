    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <ul class="votenav nav-pills nav-justified thumbnail setup-panel" style="list-style-type: none;">
                        <li class="active vote-li">
                            <a href="#step-1">
                                <h4 class="list-group-item-heading votecolor"><?= $Lang->get('VOTE__STEP_TITLE') ?> 1</h4>
                                <p class="list-group-item-text votedesc"><?= $Lang->get('VOTE__STEP_SET_USER') ?></p>
                            </a>
                        </li>
                        <li class="disabled vote-li">
                            <a href="#step-2">
                                <h4 class="list-group-item-heading votecolor"><?= $Lang->get('VOTE__STEP_TITLE') ?> 2</h4>
                                <p class="list-group-item-text votedesc"><?= $Lang->get('VOTE__STEP_SET_WEBSITE') ?></p>
                            </a>
                        </li>
                        <li class="disabled vote-li">
                            <a href="#step-3">
                                <h4 class="list-group-item-heading votecolor"><?= $Lang->get('VOTE__STEP_TITLE') ?> 3</h4>
                                <p class="list-group-item-text votedesc"><?= $Lang->get('VOTE__STEP_GET_REWARDS') ?></p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row step active" id="step-1">
                <div class="col-12">
                    <div class="col-md-12 well setup-content text-center" style="background: #0d0d0d;">
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            <div style="width: 350px;display: inline-block;">
                                ...
                                <input type="text" class="form-control" style="font-size: initial;" name="username" placeholder="Kr0ZiX" <?= ($user) ? 'value="' . $user['pseudo'] . '" disabled' : '' ?>>
                            </div>
                            <br><br>
                            <button class="btn btn-primary" type="submit" style="font-size: initial;">Passer a l'étape suivante</button>
                            <a class="btn btn-primary" id="display-rewards" data-toggle="modal" data-target="#rewards" style="color:white;font-size: initial;"><?= $Lang->get('VOTE__DISPLAY_REWARDS'); ?></a>
                        </form>
        ...
        <div class="col-md-12">
            ...
            <div class="well" style="background: #0d0d0d;">
