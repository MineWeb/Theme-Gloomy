    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-sm-12 mt20">
            ...
            <form method="post" action="<?= $this->here ?>">
                ...
                <div class="forum-forum" style="background-color: #0d0d0d;">
                    <div class="forum-other-header" style="background-color: #0d0d0d;color: #c4c4c4;">
                        <p class="forum-forum-title" style="color: #c4c4c4;"><i class="fa fa-font" aria-hidden="true"></i> <?= $Lang->get('FORUM__TITLE__TOPIC'); ?></p>
                    </div>
                ...
                <div class="forum-forum">
                    <div class="forum-other-header" style="background-color: #0d0d0d;color: #c4c4c4;">
                        <p class="forum-forum-title" style="background-color: #0d0d0d;color: #c4c4c4;"><i class="fa fa-cog" aria-hidden="true"></i> <?= $Lang->get('FORUM__SETTINGS'); ?></p>
                    </div>
                    <div class="forum-category" style="background-color: #0d0d0d;color: #c4c4c4;">
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="forum-forum">
                    <div class="forum-other-header" style="background-color: #0d0d0d;color: #c4c4c4;">
                        <p class="forum-forum-title" style="background-color: #0d0d0d;color: #c4c4c4;"><i class="fa fa-cog" aria-hidden="true"></i> <?= $Lang->get('FORUM__TAGS'); ?></p>
                    </div>
                    <div class="forum-category" style="background-color: #0d0d0d;color: #c4c4c4;">
                        <div class="row">
                            <div class="col-md-12">
