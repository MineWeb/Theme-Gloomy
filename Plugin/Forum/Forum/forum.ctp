    ...
    <?php if(!empty($alertforum['update'])) echo $alertforum['update']; ?>
            ...
            <div class="col-md-9">
                <ol class="forum-breadcrumb" style="background-color: #0d0d0d;">
                    ...
                    <?php foreach ($breadcrumb as $key => $b): ?>
                        <li class="forum-breadcrumb-href" style="color: #c4c4c4;">
        ...
        <div class="forum-forum">
            <div class="forum-forum-header" style="background-color: #0d0d0d;">
                <p class="forum-forum-title" style="color: #c4c4c4;"><i class="fa fa-folder-open" aria-hidden="true"></i> <?= $parent['forum_parent']['name']; ?></p>
            </div>
