...
<div class="background-forum">
    <div class="<?= $theme; ?> marge">
        ...
        <div class="row">
            <div class="col-md-10">
                <ol class="forum-breadcrumb" style="background-color: #0d0d0d;">
                    <li class="forum-breadcrumb-home">
                        <a href="<?= $this->Html->url('/forum') ?>" class="forum-breadcrumb-fahome" style="color: #c4c4c4;"><i class="fa fa-home" aria-hidden="true"></i></a>
                    </li>
                </ol>
            </div>
            <div class="col-md-2">
                <ol class="forum-breadcrumb forum-breadcrumb-menu" style="background-color: #0d0d0d;">
                    <?php if($perms['FORUM_VIEW_REPORT']): ?>
                        <li class="forum-left">
                            <a href="<?= $this->Html->url('/forum/report') ?>" class="forum-breadcrumb-faflag" style="color: #c4c4c4;"><i class="fa fa-flag" aria-hidden="true"></i></a>
                        </li>
                    <?php endif; ?>
                    <?php if($active['privatemsg'] && isset($_SESSION['user'])): ?>
                        <li class="forum-left">
                            <a href="<?= $this->Html->url('/message') ?>" class="forum-breadcrumb-faenvelope" style="color: #c4c4c4;"><i class="fas fa-envelope" aria-hidden="true"></i></a>
                        </li>
                    <?php endif; ?>
                    <?php if(isset($_SESSION['user'])): ?>
                        <li class="forum-left">
                            <a href="<?= $this->Html->url('/user/'.$my['user'].'.'.$my['id'].'/') ?>" class="forum-breadcrumb-fauser" style="color: #c4c4c4;"><i class="fa fa-user" aria-hidden="true"></i></a>
                        </li>
                        <li class="forum-left last">
                            <a href="<?= $this->Html->url('/user/logout') ?>" class="forum-breadcrumb-fasignout" style="color: #c4c4c4;"><i class="fas fa-sign-out-alt" aria-hidden="true"></i></a>
                        </li>
                    <?php else: ?>
                        <li class="forum-left last">
                            <a href="#" data-toggle="modal" data-target="#login" class="forum-breadcrumb-fasignin" style="color: #c4c4c4;"><i class="fas fa-sign-in-alt" aria-hidden="true"></i></a>
                        </li>
                    <?php endif; ?>
                </ol>
            </div>
        ...
        <?php foreach ($forums as $f => $forum): ?>
            <?php if($forum['Forum']['id_parent'] == 0): $p = $forum['Forum']['id']; ?>
                <div class="forum-forum" data-id="<?= $forum['Forum']['id']; ?>" data-hidden="false" style="background-color: #0d0d0d;">
                    <div class="forum-forum-header" style="background-color: #0d0d0d;">
                        <p class="forum-forum-title inline" style="background-color: #0d0d0d;color: #c4c4c4;">
                    ...
                    <?php foreach ($forums as $f => $forum): ?>
                        <?php if($forum['Forum']['id_parent'] != 0 && $forum['Forum']['id_parent'] == $p): ?>
                            <div class="forum-category" style="color: #c4c4c4;">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7 col-md-7 col-sm-6">
                                        <h3 class="forum-category-title">
                                            <a style="color:#c4c4c4" href="<?= $forum['Forum']['href']; ?>">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-3 hidden-mob forum-category-last">
                                        <?php if($forum['Forum']['nb_discussion'] != 0 && $forum['Forum']['nb_message'] != 0): ?>
                                            <a style="color:#c4c4c4" href="<?= $forum['Forum']['topic_last_href']; ?>"><?= $this->Text->truncate(h($forum['Forum']['topic_last_title']), 70); ?></a><br/>
        ...
        <?php if($active['statistics']): ?>
            <div class="forum-forum" style="background-color: #0d0d0d;color: #c4c4c4;">
                <div class="forum-other-header" style="background-color: #0d0d0d;">
                    <p style="color: #c4c4c4;" class="forum-forum-title"><i class="fa fa-bar-chart" aria-hidden="true"></i> <?= $Lang->get('FORUM__STATISTIC'); ?></p>
                </div>
        ...
        <?php if($active['useronline']): ?>
            <div class="forum-forum" style="background-color: #0d0d0d;color: #c4c4c4;">
                <div class="forum-other-header" style="background-color: #0d0d0d;">
                    <p style="color: #c4c4c4;" class="forum-forum-title"><i class="fa fa-users" aria-hidden="true"></i> <?= $Lang->get('FORUM__USER'); ?><?php if($stats['countuser'] > 1) echo 's'; ?> <?= $Lang->get('FORUM__CONNECTED'); ?><?php if($stats['countuser'] > 1) echo 's'; ?></p>
                </div>
                <div class="forum-category">
                    <div class="row">
                        <div class="col-md-12" style="font-size: initial;">
