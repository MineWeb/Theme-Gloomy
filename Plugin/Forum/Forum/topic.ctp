...
<div class="background-forum">
    <div class="<?= $theme; ?> marge">
            ...
            <div class="col-md-10 col-xs-12">
                <ol class="forum-breadcrumb" style="background-color: #0d0d0d;">
                    <li class="forum-breadcrumb-home">
                        <a href="<?= $this->Html->url('/forum') ?>" class="forum-breadcrumb-fahome"><i class="fa fa-home" aria-hidden="true" style="color: #c4c4c4;"></i></a>
                    </li>
                    <?php foreach ($breadcrumb as $key => $b): ?>
                        <li class="forum-breadcrumb-href">
                            <a href="<?= $this->Html->url('/forum/'.$b['url'].'/') ?>" style="color: #c4c4c4;">
                                <?= $b['name']; ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                    <li class="forum-breadcrumb-child" style="color: #c4c4c4;">
                ...
                <div class="col-md-2 col-xs-12 text-center">
                    <?php if($perms['FORUM_TOPIC_LOCK']): ?>
                        <form style="width: 46px" class="inline" action="" method="post">
                            ...
                            <button style="margin-left:0px;background-color: #e1e1e1;" type="submit" data-toggle="tooltip" data-placement="bottom" name="lock" value="<?= $id; ?>" title="<?php if($lock): ?><?= $Lang->get('FORUM__UNLOCK'); ?><?php else: ?><?= $Lang->get('FORUM__LOCK'); ?><?php endif; ?>" class="btn btn-theme mt30"><?php if(!$lock): ?><i class="fa fa-lock" aria-hidden="true"></i><?php else: ?><i class="fa fa-unlock" aria-hidden="true"></i><?php endif; ?></button>
                        </form>
                    <?php endif; ?>
                    <?php if($perms['FORUM_TOPIC_STICK']): ?>
                        <form style="width: 46px" class="inline" action="" method="post">
                            <input name="data[_Token][key]" value="<?= $csrfToken ?>" type="hidden">
                            <button style="margin-left:0px;background-color: #e1e1e1;" type="submit" data-toggle="tooltip" data-placement="bottom" title="<?php if($stick): ?><?= $Lang->get('FORUM__UNSTICK'); ?><?php else: ?><?= $Lang->get('FORUM__STICK'); ?><?php endif; ?>" name="stick" value="<?= $id; ?>" class="btn btn-theme mt30"><i class="fa fa-paperclip" aria-hidden="true"></i></button>
                        </form>
                    <?php endif; ?>
                    <?php if(($perms['FORUM_TOPICMY_DELETE'] &&  $_SESSION['user'] == $msgs[0]['Topic']['id_user'])|| $perms['FORUM_TOPIC_DELETE']): ?>
                        <form style="width: 46px" class="inline" action="" method="post">
                            <input name="data[_Token][key]" value="<?= $csrfToken ?>" type="hidden">
                            <button style="margin-left:0px;background-color: #e1e1e1;" type="submit" data-toggle="tooltip" data-placement="bottom" title="Supprimer" name="deleteall" value="<?= $id; ?>" class="btn btn-theme mt30"><i class="fa fa-times" aria-hidden="true"></i></button>
                        </form>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        ...
        <div class="forum-forum">
            <div class="forum-forum-header" style="background-color: #e1e1e1;">
        ...
        <?php foreach ($msgs as $msg): ?>
            <div id="<?= $msg['Topic']['id']; ?>" class="forum-forum-withoutmarge" style="background-color: #e1e1e1;">
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-sm-12">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="forum-topic-left">
                                    <div class="forum-forum-withoutmarge" style="background-color: #e1e1e1;">
