<div class="container">
    <div class="row">
        ...
        <hr>
        <form method="post" style="color: #c4c4c4;font-size: initial;" class="form-horizontal" data-ajax="true" data-redirect-url="./" action="<?= $this->Html->url(array('controller' => 'Support', 'action' => 'ajax_create')) ?>">
            ...
            <hr>
            <button class="btn btn-primary" type="submit" style="font-size: initial;"><?= $Lang->get('SUPPORT__CREATETICKET') ?></button>
        </form>
    </div>
<br></div>
