...
<div class="container">
  <div class="row">
	...
	<div class="row">
    <div class="col-md-12">
        <a class="btn btn-info btn-block" style="font-size: initial;" href="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'support', 'action' => 'create')); ?>">
            <span class="icon is-small"><i class="fa fa-plus"></i></span> <span><?= $Lang->get('SUPPORT__CREATE'); ?></span>
        </a>
        <div>
          <table class="table" style="color: #c4c4c4;font-size: initial;">
            <thead>
              <tr>
